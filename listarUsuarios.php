...
<script type="text/javascript">
	$(document).ready(function() {
		$('#myTable').DataTable( {
		"language": {
		"lengthMenu": "Mostrando _MENU_ registos por pagina",
        ...
        <div class="panel-body">	
					<!---<form name="form2" method="post" action="">
						<div class="col-sm-3  form-group" >
							<input type="text" class="input-sm form-control" name="PalavraChave" maxlength="30" size='25' placeholder="Pesquisar Usuario ou nome" required="">
				    	</div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
          ...
          <form name="editarForm" method="POST" action="">
            ...
            <div class="form-group">
              <label>Usuário(*)</label>
              <input  type="text" id="idUsuario" name="idUsuario" maxlength="20" class="form-control"  required>
            </div>
            <div class="form-group">
              <label>Função(*)</label>
              <select class="input sm form-control" id="curso"  name="curso" required="">
