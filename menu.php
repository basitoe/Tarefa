          ...
          <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse">
              ...
              <span class="icon-bar"></span>
                ...
                <a class="navbar-brand" href="inicio.php"><span style="color: #fff; font-size: 25px; "><label>Sistema Integrado de Gerenciamento de Tarefas</label></span></span></a>
          </div> 
            ...
            <ul class="nav navbar-nav" >
              ...
              <?php 
                ...
                ?>
                  <li ><a href="mensagens.php"><span class="glyphicon glyphicon-envelope" style="color: #fff; font-size:18px;"> Mensagens</span></a></li>
                <?php
                  }else{
                ?>
  ...
  <div id="usuarioModal" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-header">            
            <h4 class="modal-title">Ferfil do Utilizador</h4>
          ...
          <div class="modal-body">   
            ...
            <div class="form-group">
              <label>Usuário(*)</label>
              <input type="text" readonly class="form-control" name="idUsuario" maxlength="" value="<?php  echo $resultado['idUsuario'] ?>" required>
            </div>
            <div class="form-group">
              <label>Função(*)</label>
            ...
            <div class="form-group">
              <label>Celular(*)</label>
              <input type="text" readonly class="form-control" name="celular"  maxlength="9" value="<?php  echo $resultado['celular'] ?>" required>
            </div>
            <div class="form-group">
              <label>Email(*)</label>
              <input type="email"readonly  class="form-control" name="email" maxlength="40" value="<?php  echo $resultado['email'] ?>" required>
            </div>         
          </div>
          <div class="modal-footer">
            <input type="button" class="btn btn-default" data-dismiss="modal" name="Cancel" value="Fechar">
            <input type="submit" hidden="" class="btn btn-info" name="usuarioModal" value="Gravar">
          </div>
        </form>
      </div>
    </div>
