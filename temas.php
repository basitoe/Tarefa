    ...
    <div class="panel panel-default panel-table">
        <div class="panel-heading" >
              ...
              <p>
                	...
                	<div class="divH"><label>Registo de actividades Realizadas</label></div>
...
<!-- Inicio Modal Apagar -->
				...
				<h4 class="modal-title custom_align" id="Heading">Apagar a Actividade</h4>
				</div>
				...
				<div class="alert alert-danger"><span class=""></span> Tem a certeza que desejas Apagar a Actividade?</div>
				</div>
				<div class="modal-footer ">
