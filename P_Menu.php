...
<nav class="navbar navbar-default sidebar"  role="navigation" style="z-index: 1;">
    ...
    <?php } ?> 
            <li class=""><a href="temas.php">Actividades Realizadas<span style="font-size:16px;" class="pull-right showopacity glyphicon glyphicon-pencil"></span></a></li>
            <li class=""><a href="proj_tcc.php">Cadastros<span style="font-size:16px;" class="pull-right showopacity glyphicon glyphicon-book"></span></a></li>
            <li class=""><a href="monografia.php">Tarefas<span style="font-size:16px;" class="pull-right showopacity glyphicon glyphicon-list"></span></a></li>
