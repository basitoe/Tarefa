    ...
    <div class="panel panel-default panel-table">
        <div class="panel-heading" >
              ...
              <p>
                	...
                	<div class="divH"><label>Função</label></div>
...
<!-- Inicio Modal Apagar -->
				...
				<h4 class="modal-title custom_align" id="Heading">Eliminar Função</h4>
				</div>
				...
				<div class="alert alert-danger"><span class=""></span> Tens a certeza que desejas Eliminar a Função? </div>
				</div>
				<div class="modal-footer ">
