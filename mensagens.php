    ...
    <div class="panel panel-default panel-table">
        <div class="panel-heading" >
              ...
              <p>
                	...
                	<div class="divH"><label>Mensagens do Usuário</label></div>
...
<!-- Inicio Modal Apagar -->
				...
				<script type="text/javascript">
					$('#delete').on('show.bs.modal', function (event) {
					  ...
					  var modal = $(this)
					  modal.find('.modal-title').text('Apagar Mensagem de: ' + recipient)
...
<!-- Reportar um problema Modal HTML -->
  ...
  <script type="text/javascript">
					$('#responder').on('show.bs.modal', function (event) {
					  ...
					  var modal = $(this)
					  modal.find('.modal-title').text('Responder Mensagem de: ' + nome)
					  modal.find('#id').val(recipient)
