    ...
    <div class="panel panel-default panel-table">
        <div class="panel-heading" >
              ...
              <p>
                	...
                	<div class="divH"><label>Cadastro de Empresas </label></div>
        ...
        <div class="panel-body">	
				<!--	<form name="form2" method="post" action="">
						<div class="col-sm-3  form-group" >
							<input type="text" class="input-sm form-control" name="PalavraChave" maxlength="30" size='25' placeholder="Pesquisar Tarefa" required="">
				    	</div>
	        ...
	        <div class="col col-xs-1 col-md-12 col-sm-12 col-lg-12">
	              		
	            <div class="row-fluid">
		            <div class="table-responsive">
						<form name="form1" method="post" action="">
						<div align="right">
				            			<a href="#adicionar_proj_Modal" data-toggle="modal"><i  data-toggle="tooltip"></i><img src="pics/upload.png" class="img-responsive" style="max-width: 30px;" title="Fazer upload"></a>
				            			<div class="divH"><i></i> </div>
				            			</br>
									</div>
				            <?php 
...
<!-- /container -->
				    ...
				    <div class="modal-dialog">
				      <div class="modal-content">
				          <div class="modal-header">            
				            <h4 class="modal-title">Submeter Tarefa</h4>
				          ...
				          <div class="modal-body">   
				            ...
				            <div class="form-group">
				              ...
				              <input type="text" id="tema" name="tema" autofocus="" maxlength="700" class="form-control" placeholder="Digite o nome da empresa" required>
				            </div>
				            
				            <div class="form-group">
				              <label>Descricão</label>(*)
				              <textarea  id="descricao" name="descricao" placeholder="Descricão da empresa" class="form-control" required=""></textarea>
				            </div>
				            ...
				            <div class="form-group">
				              ...
				              <select id="supervisor" name="supervisor" class="form-control" >
				              	<optgroup>
				              		...
				              		<?php 
				                      $query=mysqli_query($conectar,"SELECT * FROM `tabela_usuarios` WHERE idNivelAcesso='2' OR idNivelAcesso='2'");
				  ...
				  <div id="avaliar_Modal" class="modal fade">
				    <div class="modal-dialog">
				      <div class="modal-content">
				          <div class="modal-header">            
				            <h4 class="modal-title">Avaliar Tarefa</h4>
				            <button type="button"  class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				          </div>
				          <br>
				          ...
				          <div class="modal-body">   
				            ...
				            <div class="form-group">
				              ...
				              <input type="text" readonly="" id="tema" name="tema" autofocus="" maxlength="700" class="form-control" placeholder="Digite o nome da Empresa" required>
				              <label>Descricão(*)</label>
				               <textarea  id="descricao" readonly="" name="descricao" placeholder="Descrever Empresa" class="form-control" ></textarea>
				            </div>
				            ...
				            <div class="form-group">
				              ...
				              <textarea  id="obs"  name="obs" placeholder="Observações " class="form-control" ></textarea>
				            </div>
				            ...
				            <div class="form-group">
				              ...
				              <select id="supervisor" name="supervisor" class="form-control" >
				              	<optgroup>
				              		<option value="">Selecione aqui</option>
				              		<?php 
				                      $query=mysqli_query($conectar,"SELECT * FROM `tabela_usuarios` WHERE idNivelAcesso='1' OR idNivelAcesso='1'");
				                      while($rs=mysqli_fetch_array($query)){ 
			...
			if(isset($_POST['aprovar_proj_Modal'] )){
				...
				$notificacao=mysqli_query($conectar,"INSERT INTO `notificacoes`(`Titulo`, `Texto`, `id_nivel_acesso`, `id_Usuario`, `id_Destinatario`, `Estado`) VALUES ('O seu pedido foi $nome_estado!','O seu pedidoo foi $nome_estado!','','$idUsuario','$user_dest','1')");
				if($estado==1){
				$notificacao=mysqli_query($conectar,"INSERT INTO `notificacoes`(`Titulo`, `Texto`, `id_nivel_acesso`, `id_Usuario`, `id_Destinatario`, `Estado`) VALUES ('Pedido','Foi selecionado como o supervisor $nome','','$idUsuario','$idSupervisor','1')");
				}
				if ($estado==1) {
...
<!-- Inicio Modal Apagar -->
				...
				<h4 class="modal-title custom_align" id="Heading">Eliminar Tarefa</h4>
				</div>
				<br>
				<div class="text-center"><i class="fa fa-file fa-7x fa-fw" style="color: #1EA4DD;"></i></div>
				...
				<div class="alert alert-danger"><span class=""></span> Tem a Certeza que Deseja Eliminar Esta Tarefa?</div>
				</div>
				<div class="modal-footer ">
		...
		$('#delete').on('show.bs.modal', function (event) {
		  ...
		  var modal = $(this)
		  modal.find('.modal-title').text('Atenção: Está prestes a eliminar a Tarefa.' )
